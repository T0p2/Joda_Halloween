...
Luego crea un archivo llamado `.env` en la carpeta `server` con este contenido:
...
3. **Comprar entradas**: Selecciona un evento y compra tus entradas
4. **Pagar**: Usa MercadoPago para pagar de forma segura
5. **Recibir entradas**: Las entradas llegan por email con código QR
...
2. **Validar entradas**: Escanea los códigos QR en la entrada
3. **Ver ventas**: Revisa cuántas entradas se vendieron
