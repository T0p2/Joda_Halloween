...
router.post('/create-preference', async (req, res) => {
  try {
    ...
    if (error.message.includes('invalid_token')) {
      ...
      details = 'Las credenciales de acceso no son válidas. Verifica tu configuración.';
    } else if (error.message.includes('bad_request')) {
      errorMessage = 'Error en la configuración de MercadoPago';
      details = 'Verifica que las credenciales tengan el formato correcto.';
    } else if (error.message.includes('unauthorized')) {
      errorMessage = 'No autorizado para usar MercadoPago';
      details = 'Las credenciales no tienen permisos suficientes.';
    }
